...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/serglokhm/DScrollView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'serglokhm' => 'sergey.lokhmachev@pipedrive.com' }
  s.source           = { :git => 'https://github.com/serglokhm/DScrollView.git', :tag => s.version.to_s }
